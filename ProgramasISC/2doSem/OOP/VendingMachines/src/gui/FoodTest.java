...
public class FoodTest extends javax.swing.JFrame {
    ...
    public FoodTest() {// Creates new form Food
        initComponents();
        setLocationRelativeTo(null);
        initialSettings();
        this.products=products;
        this.coins=coins;
        this.user=new User("Customer", 10);
        this.machine1=new Machine(user, coins, products);
    ...
    public void setMachine(Machine machine1){
    ...
    */
    ...
    public void checkPossibleBuy(){//Checks if with the money inside the machine, the user can buy another product
        ...
        if(machine1.validateMoneyIntroduced(number, total_introduced)==false){// validate if with the number intorduced you could buy the other product selected
            buy_button.setVisible(false);
    ...
    private void buy_buttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buy_buttonMouseClicked
        ...
        filename="src/logic/machine1.txt";
